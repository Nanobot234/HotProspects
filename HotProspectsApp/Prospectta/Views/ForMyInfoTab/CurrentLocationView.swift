...
struct CurrentLocationView: View {
    ...
    var body: some View {
        ...
        Section {
            ...
            Text(" When you scan someones QR code, the location you meet the person will be set to this location that you specify. If you dont add your lcoation, you will be asked to enter the location you met a person everytime you scan their QR code.")
        }
