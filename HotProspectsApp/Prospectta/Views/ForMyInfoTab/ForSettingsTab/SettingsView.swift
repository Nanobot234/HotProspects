...
//
   // @State private var isUnlocked = false
    ...
    let propectsTabDescription = "In the Prospects tab, use the blue icon on the bottom right of the prspects page to scan a prospect's QR code and you will instantly have access to all the contact info they share with you.\n\nCurrently, you can only scan a QR code of someone else who also has the app."
    let profileTabDescription = "In the Me tab, update your contact information and easily choose which one you want to share with prospects. Then click on the My QR Code button to display a QR code that others can scan to save your information\n\nYou can also share your contact card with someone else"
